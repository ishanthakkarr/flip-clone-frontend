  ...
  const onConfirmOrder = async () => {
    ...
    if (paymentOptionValue) {
      ...
      const options = {
        ...
        amount: user.paymentDetail.data.amount, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
        currency: user.paymentDetail.data.currency,
        // _id:auth.user._id
        name: "ISHAN Thakkar",
        description: user.paymentDetail.data.notes.desc,
        image:
        ...
        order_id: user.paymentDetail.data.id, //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
